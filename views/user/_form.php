...
<div class="users-form">
    ...
    <?php 
        if($from === 'create'){
            ...
            echo $form->field($model, 'password', ['labelOptions' => ['class' => 'form-required']])->passwordInput(['minlength' => 6, 'maxlength' => 64, 'class' => 'form-control', 'placeholder' => 'Введите пароль']);
            echo $form->field($model, 'password_repeat', ['labelOptions' => ['class' => 'form-required']])->passwordInput(['maxlength' => 64, 'placeholder' => 'Введите пароль повторно', 'class' => 'form-control']);
        }
    ?>
